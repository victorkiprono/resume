            ...
            >
                <div  className={classes.image_container} >
                    ...
                    <div  className={classes.h1}>
                        <h1 >I'm VICTOR</h1>
                        <a 
                            href="https://drive.google.com/file/d/1LjKCu3En4VBdfXCOzeDMrzJQQSpQskLT/view?usp=sharing" 
                ...
                <div className={classes.image_container}>
                    ...
                    <h1>THINGS!!</h1>
                    <a href="https://github.com/victorkiprono" rel="opener noreferrer" target="_blank">VIEW PROJECTS   <GoProject/></a>
                    </div>
                </div>
                <div className={classes.image_container}>
